 ...
 public:
  ...
  void ComputeHelper(tensorflow::OpKernelContext* context,
    ...
    OP_REQUIRES(context, depth_multiplier == 1,
                absl::InvalidArgumentError("Depth multiplier must be 1."));
    ...
    OP_REQUIRES(context, input_rows == input_cols,
                absl::InvalidArgumentError("Only supports square images."));
    OP_REQUIRES(context, filter_rows == 3,
                absl::InvalidArgumentError("Only supports 3x3 kernels."));
    ...
    OP_REQUIRES(context, GetTensorDim(padding_, data_format_, 'C') == 0,
                absl::InvalidArgumentError("Channel padding not supported."));
    OP_REQUIRES(context, GetTensorDim(padding_, data_format_, 'N') == 0,
                absl::InvalidArgumentError("Batch padding not supported."));
    OP_REQUIRES(
        context, pad_rows == pad_cols,
        absl::InvalidArgumentError("Height and width padding must match."));
